...
public class EnergyModelComputingNode {
	...
	public void setDeviceType(SimulationParameters.TYPES deviceType) {
...
//		if(deviceType != SimulationParameters.TYPES.EDGE_DEVICE) { //comsidering only dynamic energy consumption of UE device
//			cpuEnergyConsumption += getIdleConsumption() / 3600 * SimulationParameters.UPDATE_INTERVAL;
//		} else {
//			cpuEnergyConsumption += 0.000023 / 3600 * SimulationParameters.UPDATE_INTERVAL;
//		}
	}
