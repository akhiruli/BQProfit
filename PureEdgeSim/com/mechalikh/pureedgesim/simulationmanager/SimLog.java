...
public class SimLog {
	...
	private void printGeneric(){
		...
		System.out.println("Total tasks execution time: " + totalExecutionTime+" seconds");
		System.out.println("Average task execution time: "+decimalFormat.format(totalExecutionTime / executedTasksCount)+" seconds");
		System.out.println("Average task waiting time: " + decimalFormat.format(totalWaitingTime / executedTasksCount) + " seconds");
		System.out.println("Tasks successfully executed: " +  decimalFormat.format((double) (tasksSent - tasksFailed) * 100 / tasksSent)
				+ " % (" + (tasksSent - tasksFailed) + " among " + tasksSent + " sent tasks)");
		System.out.println("Task Executed on cloud: "+(tasksExecutedOnCloud - tasksFailedCloud));
		System.out.println("Task Executed on edge: "+(tasksExecutedOnEdge - tasksFailedEdge));
		System.out.println("Task Executed in UE: "+ (tasksExecutedOnMist - tasksFailedMist));
		...
		System.out.println("Total UE energy consumption: "+mistEnConsumption);
	}
